...
#include "esp_lcd_touch_gt911.h" //References for Touch GT911 Function-related API Functions
...
#define Touch_GPIO_RST CONFIG_TOUCH_GPIO_RST // TOUCH Reset GPIO
#define Touch_GPIO_INT CONFIG_TOUCH_GPIO_INT // TOUCH INT GPIO
esp_err_t touch_init(void);                  // Touch Initialization Function
